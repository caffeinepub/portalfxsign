...
export class Backend implements backendInterface {
    ...
    async createAccount(arg0: string, arg1: string, arg2: string, arg3: string | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createAccount(arg0, arg1, arg2, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAccountStatistics(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getAccountStatistics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listAllAccounts(): Promise<Array<Account>> {
        if (this.processError) {
            try {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        planId: record_opt_to_undefined(from_candid_opt_n10(_uploadFile, _downloadFile, value.planId)),
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Account>): Array<Account> {
    return value.map((x)=>from_candid_Account_n8(_uploadFile, _downloadFile, x));
}
